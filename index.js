...
function playerMovement() {
	if (keyIsDown(37)&&player1.position.x-25>0) {
		if (jumping1) {
	...
	if (keyIsDown(39)&&player1.position.x+25<width) {
		if (jumping1) {
			player1.position.x += 12;
		}
		else {
	...
	if (keyIsDown(65)&&player2.position.x-25>0) {
		if (jumping2) {
	...
	if (keyIsDown(68)&&player2.position.x+25<width) {
		if (jumping2) {
			player2.position.x += 12;
		}
		else {
...
function menu() {
	console.log("Maybe I should develop this part")
}

function gameOver() {
	console.log("I should probably also develop this too")
}
